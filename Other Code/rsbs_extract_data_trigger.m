function [DPOP]=rsbs_extract_data_trigger(out,ADDINF,idinf,NID,EYE,EYEINF,LN,RIXSES)
...
[DPOP]=rsbs_extra_data_trigger_pop(SIG,idinf,NID,ODOURDELAY,LN,RIXSES,gratingonnormal,gratingon2); % Added on 13/07/2016 (AC)
