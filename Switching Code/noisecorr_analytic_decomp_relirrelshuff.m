function [ctot_pre, ctot_post, corr_tot_pre, corr_tot_post] = noisecorr_analytic_decomp_relirrelshuff(xpre, xpost, rmat_pre, rmat_post, ResidualV_pre_TOT, ResidualV_post_TOT, vmatpre0, vmatpost0, Trialspre_all, Trialspost_all, tsims, rngtot, CELLLAB_ALL, RXS)
